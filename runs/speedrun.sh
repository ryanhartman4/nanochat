...
torchrun --standalone --nproc_per_node=8 -m scripts.base_train -- --depth=24 --target-param-data-ratio=8 --device-batch-size=16 --fp8 --nca-data=$NANOCHAT_BASE_DIR/nca_data --nca-lr=1e-4 --nca-alphabet-size=10 --nca-batch-size=8 --run=$WANDB_RUN
